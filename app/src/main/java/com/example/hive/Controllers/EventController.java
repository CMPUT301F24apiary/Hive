...
/**
 * Controller to handle retrieving all events from the Firestore database.
 * Extends <code>FirebaseController</code> and implements additional methods relating to events.
 *
 * @author Zach
 */
public class EventController extends FirebaseController {
    ...
    /**
     * Constructor - call <code>FirebaseController</code>'s constructor and initialize the database reference.
     */
